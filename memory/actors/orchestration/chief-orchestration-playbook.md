...
- Security rows map to `ag-sec-*` profiles and in-repo role prompt bundle `policies/core/runtime/agent/memory/governance/source/role-prompts/security-foundation-agents-role-prompts.md` (sections AG-004, AG-006–AG-013).
