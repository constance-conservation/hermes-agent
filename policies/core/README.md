...
> **Governance read order** — step 4 of 53 in the canonical `policies/` sequence (layer map & tables: [`README.md`](../README.md)).
...
Same files as the table above: runbooks → handoff → packs → [`pipeline-runbook.md`](pipeline-runbook.md) → activation. [`../INDEX.md`](../INDEX.md) is regenerated by the pipeline script.
