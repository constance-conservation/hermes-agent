...
> **Governance read order** — step 61 of 61 in the canonical `policies/` sequence (layer map & tables: [`README.md`](README.md)).
...
- `policies/core/scripts/README.md`
- `policies/core/security-first-setup.md`
- `policies/core/security-prompts.md`
- `policies/core/unified-deployment-and-security.md`
- `policies/README.md`
- `policies/INDEX.md` (this file)

<!-- policy-read-order-nav:bottom -->
> **Next step:** end of the canonical `policies/*.md` sequence for this repository snapshot. Use operational registers under [`operations/`](../operations) and [`README.md`](README.md) (generated output & operations) for runtime memory and project trees.
